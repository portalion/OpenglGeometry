...
circles. Still not handled: following a self-*crossing* curve continuously **through** its
crossing point — a figure-eight comes out as its two closed sub-loops, each passing near the
crossing, rather than one continuously traced curve.
